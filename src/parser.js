...
break;
case 2:this.$ = Bully.Nodes.Body.create();
break;
case 3:this.$ = Bully.Nodes.Body.wrap([$$[$0-1+1-1]]);
break;
case 4:this.$ = Bully.Nodes.Body.wrap([$$[$0-1+1-1]]);
break;
...
break;
case 19:this.$ = Bully.Nodes.Constant.create($$[$0-1+1-1]);
break;
case 20:this.$ = Bully.Nodes.Self.create();
break;
case 21:this.$ = Bully.Nodes.Return.create([$$[$0-2+2-1]]);
break;
case 22:this.$ = Bully.Nodes.Return.create();
break;
case 23:this.$ = Bully.Nodes.Literal.create("NUMBER", $$[$0-1+1-1]);
break;
case 24:this.$ = Bully.Nodes.Literal.create("STRING", $$[$0-1+1-1]);
break;
case 25:this.$ = Bully.Nodes.Literal.create("NIL");
break;
case 26:this.$ = Bully.Nodes.Literal.create("TRUE");
break;
case 27:this.$ = Bully.Nodes.Literal.create("FALSE");
break;
case 28:this.$ = Bully.Nodes.Call.create(null, $$[$0-1+1-1], null);
break;
case 29:this.$ = Bully.Nodes.Call.create(null, $$[$0-4+1-1], $$[$0-4+3-1]);
break;
case 30:this.$ = Bully.Nodes.Call.create($$[$0-3+1-1], $$[$0-3+3-1], null);
break;
case 31:this.$ = Bully.Nodes.Call.create($$[$0-6+1-1], $$[$0-6+3-1], $$[$0-6+5-1]);
break;
case 32:this.$ = $$[$0-2+1-1];
break;
case 33:$$[$0-5+1-1].addElse($$[$0-5+4-1].needsReturn());
break;
case 34:this.$ = Bully.Nodes.If.create([$$[$0-4+2-1], $$[$0-4+4-1].needsReturn()]);
break;
case 35:$$[$0-2+1-1].push($$[$0-2+2-1]);
break;
case 36:this.$ = Bully.Nodes.If.create([$$[$0-4+2-1], $$[$0-4+4-1].needsReturn()]);
break;
...
break;
case 40:this.$ = Bully.Nodes.ArgList.create();
break;
case 41:this.$ = Bully.Nodes.ArgList.create([$$[$0-1+1-1]]);
break;
case 42:$$[$0-3+1-1].push($$[$0-3+3-1]);
break;
case 43:this.$ = Bully.Nodes.Def.create($$[$0-5+2-1], Bully.Nodes.ParamList.create(), $$[$0-5+4-1].needsReturn());
break;
case 44:this.$ = Bully.Nodes.Def.create($$[$0-8+2-1], $$[$0-8+4-1], $$[$0-8+7-1].needsReturn());
break;
case 45:this.$ = Bully.Nodes.ParamList.create();
break;
case 46:this.$ = Bully.Nodes.ParamList.create([$$[$0-1+1-1]]);
break;
case 47:this.$ = Bully.Nodes.ParamList.create([$$[$0-1+1-1]]);
break;
case 48:this.$ = Bully.Nodes.ParamList.create([$$[$0-1+1-1]]);
break;
case 49:this.$ = Bully.Nodes.ParamList.create([$$[$0-3+1-1], $$[$0-3+3-1]]);
break;
case 50:this.$ = Bully.Nodes.ParamList.create([$$[$0-5+1-1], $$[$0-5+3-1], $$[$0-5+5-1]]);
break;
case 51:this.$ = Bully.Nodes.ParamList.create([$$[$0-3+1-1], $$[$0-3+3-1]]);
break;
case 52:this.$ = Bully.Nodes.ParamList.create([$$[$0-3+1-1], $$[$0-3+3-1]]);
break;
case 53:this.$ = Bully.Nodes.ReqParamList.create($$[$0-1+1-1]);
break;
case 54:$$[$0-3+1-1].push($$[$0-3+3-1]);
break;
case 55:this.$ = Bully.Nodes.OptParamList.create($$[$0-3+1-1], $$[$0-3+3-1]);
break;
case 56:$$[$0-5+1-1].push($$[$0-5+3-1], $$[$0-5+5-1]);
break;
case 57:this.$ = Bully.Nodes.SplatParam.create($$[$0-2+2-1]);
break;
case 58:this.$ = Bully.Nodes.LocalAssign.create($$[$0-3+1-1], $$[$0-3+3-1]);
break;
case 59:this.$ = Bully.Nodes.InstanceAssign.create($$[$0-4+2-1], $$[$0-4+4-1]);
break;
case 60:this.$ = Bully.Nodes.ClassAssign.create($$[$0-5+3-1], $$[$0-5+5-1]);
break;
case 61:this.$ = Bully.Nodes.ConstantAssign.create($$[$0-3+1-1], $$[$0-3+3-1]);
break;
case 62:this.$ = Bully.Nodes.Class.create($$[$0-5+2-1], null, [$$[$0-5+4-1]]);
break;
case 63:this.$ = Bully.Nodes.Class.create($$[$0-7+2-1], $$[$0-7+4-1], [$$[$0-7+6-1]]);
break;
}
},
